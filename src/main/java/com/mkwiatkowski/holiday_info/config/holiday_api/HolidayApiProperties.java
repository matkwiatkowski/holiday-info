package com.mkwiatkowski.holiday_info.config.holiday_api;
...
public record HolidayApiProperties(String url, String apiKey) {
    ...
    /**
     * Validates if all configuration properties for Holiday API are properly set.
     * NOTE: this should be called only if Holiday API is enabled in the system.
     * Checks:
     * <ul>
